...
#include "mid360_driver/msg/detail/custom_point__type_support.h"
...
static const _CustomPoint_type_support_symbol_names_t _CustomPoint_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mid360_driver, msg, CustomPoint)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mid360_driver, msg, CustomPoint)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mid360_driver, msg, CustomPoint)() {
  return &::mid360_driver::msg::rosidl_typesupport_c::CustomPoint_message_type_support_handle;
}
