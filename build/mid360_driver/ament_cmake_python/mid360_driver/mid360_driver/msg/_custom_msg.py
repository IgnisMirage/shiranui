...
class Metaclass_CustomMsg(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from mid360_driver.msg import CustomPoint
...
class CustomMsg(metaclass=Metaclass_CustomMsg):
    ...
    _fields_and_field_types = {
        ...
        'lidar_id': 'uint8',
        'rsvd': 'uint8[3]',
        'points': 'sequence<mid360_driver/CustomPoint>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['mid360_driver', 'msg'], 'CustomPoint')),  # noqa: E501
    )
