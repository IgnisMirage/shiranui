...
#include "mid360_driver/msg/detail/custom_msg__rosidl_typesupport_fastrtps_c.h"
...
#include "mid360_driver/msg/detail/custom_point__functions.h"  // points
#include "std_msgs/msg/detail/header__functions.h"  // header

// forward declare type support functions

bool cdr_serialize_mid360_driver__msg__CustomPoint(
  const mid360_driver__msg__CustomPoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

bool cdr_deserialize_mid360_driver__msg__CustomPoint(
  eprosima::fastcdr::Cdr & cdr,
  mid360_driver__msg__CustomPoint * ros_message);

size_t get_serialized_size_mid360_driver__msg__CustomPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_mid360_driver__msg__CustomPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

bool cdr_serialize_key_mid360_driver__msg__CustomPoint(
  const mid360_driver__msg__CustomPoint * ros_message,
  eprosima::fastcdr::Cdr & cdr);

size_t get_serialized_size_key_mid360_driver__msg__CustomPoint(
  const void * untyped_ros_message,
  size_t current_alignment);

size_t max_serialized_size_key_mid360_driver__msg__CustomPoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment);

const rosidl_message_type_support_t *
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mid360_driver, msg, CustomPoint)();
...
using _CustomMsg__ros_msg_type = mid360_driver__msg__CustomMsg;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_mid360_driver__msg__CustomPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  mid360_driver__msg__CustomMsg * ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      mid360_driver__msg__CustomPoint__Sequence__fini(&ros_message->points);
    }
    if (!mid360_driver__msg__CustomPoint__Sequence__init(&ros_message->points, size)) {
      fprintf(stderr, "failed to create array for field 'points'");
      return false;
    }
    auto array_ptr = ros_message->points.data;
    for (size_t i = 0; i < size; ++i) {
      cdr_deserialize_mid360_driver__msg__CustomPoint(cdr, &array_ptr[i]);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_mid360_driver__msg__CustomPoint(
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_mid360_driver__msg__CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mid360_driver__msg__CustomMsg;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    ...
    cdr << static_cast<uint32_t>(size);
    for (size_t i = 0; i < size; ++i) {
      cdr_serialize_key_mid360_driver__msg__CustomPoint(
        &array_ptr[i], cdr);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_key_mid360_driver__msg__CustomPoint(
        &array_ptr[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Field name: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_key_mid360_driver__msg__CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mid360_driver__msg__CustomMsg * ros_message = static_cast<const mid360_driver__msg__CustomMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mid360_driver__msg__CustomMsg(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mid360_driver__msg__CustomMsg * ros_message = static_cast<mid360_driver__msg__CustomMsg *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mid360_driver__msg__CustomMsg(cdr, ros_message);
}

static uint32_t _CustomMsg__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mid360_driver__msg__CustomMsg(
...
static size_t _CustomMsg__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mid360_driver__msg__CustomMsg(
