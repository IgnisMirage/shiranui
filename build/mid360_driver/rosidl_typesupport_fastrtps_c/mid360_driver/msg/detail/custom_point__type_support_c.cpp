...
#include "mid360_driver/msg/detail/custom_point__rosidl_typesupport_fastrtps_c.h"
...
using _CustomPoint__ros_msg_type = mid360_driver__msg__CustomPoint;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mid360_driver__msg__CustomPoint;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const mid360_driver__msg__CustomPoint * ros_message = static_cast<const mid360_driver__msg__CustomPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_mid360_driver__msg__CustomPoint(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  mid360_driver__msg__CustomPoint * ros_message = static_cast<mid360_driver__msg__CustomPoint *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_mid360_driver__msg__CustomPoint(cdr, ros_message);
}

static uint32_t _CustomPoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_mid360_driver__msg__CustomPoint(
...
static size_t _CustomPoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_mid360_driver__msg__CustomPoint(
