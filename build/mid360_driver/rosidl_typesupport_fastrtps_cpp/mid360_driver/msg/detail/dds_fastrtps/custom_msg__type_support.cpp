...
#include "mid360_driver/msg/detail/custom_msg__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const mid360_driver::msg::CustomPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  mid360_driver::msg::CustomPoint &);
size_t get_serialized_size(
  const mid360_driver::msg::CustomPoint &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const mid360_driver::msg::CustomMsg & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mid360_driver::msg::CustomMsg & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mid360_driver::msg::typesupport_fastrtps_cpp::max_serialized_size_CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = mid360_driver::msg::CustomMsg;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        mid360_driver::msg::typesupport_fastrtps_cpp::max_serialized_size_key_CustomPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const mid360_driver::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mid360_driver::msg::CustomMsg *>(
    untyped_ros_message);
...
{
  return &mid360_driver::msg::typesupport_fastrtps_cpp::_CustomMsg__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mid360_driver, msg, CustomMsg)() {
  return &mid360_driver::msg::typesupport_fastrtps_cpp::_CustomMsg__handle;
}
