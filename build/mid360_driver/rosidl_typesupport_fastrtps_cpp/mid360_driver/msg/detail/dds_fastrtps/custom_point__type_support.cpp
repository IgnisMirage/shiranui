...
#include "mid360_driver/msg/detail/custom_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const mid360_driver::msg::CustomPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  mid360_driver::msg::CustomPoint & ros_message)
{
  // Member: offset_time
  cdr >> ros_message.offset_time;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mid360_driver::msg::CustomPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mid360_driver::msg::CustomPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mid360_driver::msg::CustomPoint *>(
    untyped_ros_message);
...
{
  return &mid360_driver::msg::typesupport_fastrtps_cpp::_CustomPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mid360_driver, msg, CustomPoint)() {
  return &mid360_driver::msg::typesupport_fastrtps_cpp::_CustomPoint__handle;
}
