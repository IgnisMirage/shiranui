...
bool mid360_driver__msg__custom_point__convert_from_py(PyObject * _pymsg, void * _ros_message);
PyObject * mid360_driver__msg__custom_point__convert_to_py(void * raw_ros_message);

ROSIDL_GENERATOR_C_EXPORT
bool mid360_driver__msg__custom_msg__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("mid360_driver.msg._custom_msg.CustomMsg", full_classname_dest, 39) == 0);
  }
  mid360_driver__msg__CustomMsg * ros_message = _ros_message;
  {  // header
  ...
  {  // points
    ...
    if (!mid360_driver__msg__CustomPoint__Sequence__init(&(ros_message->points), size)) {
      PyErr_SetString(PyExc_RuntimeError, "unable to create mid360_driver__msg__CustomPoint__Sequence ros_message");
      Py_DECREF(seq_field);
      Py_DECREF(field);
      return false;
    }
    mid360_driver__msg__CustomPoint * dest = ros_message->points.data;
    for (Py_ssize_t i = 0; i < size; ++i) {
      if (!mid360_driver__msg__custom_point__convert_from_py(PySequence_Fast_GET_ITEM(seq_field, i), &dest[i])) {
        Py_DECREF(seq_field);
        Py_DECREF(field);
        return false;
      }
...
ROSIDL_GENERATOR_C_EXPORT
PyObject * mid360_driver__msg__custom_msg__convert_to_py(void * raw_ros_message)
{
  /* NOTE(esteve): Call constructor of CustomMsg */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("mid360_driver.msg._custom_msg");
  ...
  mid360_driver__msg__CustomMsg * ros_message = (mid360_driver__msg__CustomMsg *)raw_ros_message;
  {  // header
    PyObject * field = NULL;
  ...
  {  // points
    ...
    for (size_t i = 0; i < size; ++i) {
      ...
      PyObject * pyitem = mid360_driver__msg__custom_point__convert_to_py(item);
      if (!pyitem) {
        Py_DECREF(field);
        return NULL;
      }
