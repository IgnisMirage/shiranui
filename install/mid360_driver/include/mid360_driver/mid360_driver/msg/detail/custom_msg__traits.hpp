...
#ifndef MID360_DRIVER__MSG__DETAIL__CUSTOM_MSG__TRAITS_HPP_
#define MID360_DRIVER__MSG__DETAIL__CUSTOM_MSG__TRAITS_HPP_
...
// Member 'points'
#include "mid360_driver/msg/detail/custom_point__traits.hpp"
...
inline void to_yaml(
  const mid360_driver::msg::CustomMsg & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const mid360_driver::msg::CustomMsg & msg)
{
  return mid360_driver::msg::to_yaml(msg);
}

template<>
inline const char * data_type<mid360_driver::msg::CustomMsg>()
{
  return "mid360_driver::msg::CustomMsg";
}

template<>
inline const char * name<mid360_driver::msg::CustomMsg>()
{
  return "mid360_driver/msg/CustomMsg";
}

template<>
struct has_fixed_size<mid360_driver::msg::CustomMsg>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<mid360_driver::msg::CustomMsg>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<mid360_driver::msg::CustomMsg>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // MID360_DRIVER__MSG__DETAIL__CUSTOM_MSG__TRAITS_HPP_
