...
mid360_driver__msg__CustomPoint__create(void)
{
  ...
  mid360_driver__msg__CustomPoint * msg = (mid360_driver__msg__CustomPoint *)allocator.allocate(sizeof(mid360_driver__msg__CustomPoint), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(mid360_driver__msg__CustomPoint));
  bool success = mid360_driver__msg__CustomPoint__init(msg);
  if (!success) {
...
mid360_driver__msg__CustomPoint__destroy(mid360_driver__msg__CustomPoint * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    mid360_driver__msg__CustomPoint__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
mid360_driver__msg__CustomPoint__Sequence__init(mid360_driver__msg__CustomPoint__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mid360_driver__msg__CustomPoint * data = NULL;

  if (size) {
    data = (mid360_driver__msg__CustomPoint *)allocator.zero_allocate(size, sizeof(mid360_driver__msg__CustomPoint), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = mid360_driver__msg__CustomPoint__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        mid360_driver__msg__CustomPoint__fini(&data[i - 1]);
      }
...
mid360_driver__msg__CustomPoint__Sequence__fini(mid360_driver__msg__CustomPoint__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      mid360_driver__msg__CustomPoint__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  mid360_driver__msg__CustomPoint__Sequence * array = (mid360_driver__msg__CustomPoint__Sequence *)allocator.allocate(sizeof(mid360_driver__msg__CustomPoint__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = mid360_driver__msg__CustomPoint__Sequence__init(array, size);
  if (!success) {
...
mid360_driver__msg__CustomPoint__Sequence__destroy(mid360_driver__msg__CustomPoint__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    mid360_driver__msg__CustomPoint__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
mid360_driver__msg__CustomPoint__Sequence__are_equal(const mid360_driver__msg__CustomPoint__Sequence * lhs, const mid360_driver__msg__CustomPoint__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!mid360_driver__msg__CustomPoint__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  mid360_driver__msg__CustomPoint__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(mid360_driver__msg__CustomPoint);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    mid360_driver__msg__CustomPoint * data =
      (mid360_driver__msg__CustomPoint *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!mid360_driver__msg__CustomPoint__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          mid360_driver__msg__CustomPoint__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!mid360_driver__msg__CustomPoint__copy(
