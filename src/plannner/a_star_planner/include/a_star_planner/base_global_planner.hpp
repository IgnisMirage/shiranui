...
public:
  ...
  void set_lethal_planning_cost(int8_t lethal_planning_cost)
  {
    lethal_planning_cost_ = lethal_planning_cost;
  }

  void set_cost_weight(double cost_weight)
  {
...
protected:
  ...
  int8_t lethal_planning_cost_ = 100;
